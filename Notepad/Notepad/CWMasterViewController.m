...
- (void)insertNewObject:(id)sender
{
    ...
    CWDetailViewController* viewController = [storyBoard instantiateViewControllerWithIdentifier:@"Detail"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        CWNote *note = [[self fetchedResultsController] objectAtIndexPath:indexPath];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    CWNote *object = [self.fetchedResultsController objectAtIndexPath:indexPath];
